...
function CardItem({ data, index, className }) {
    return (
        <Draggable 
            index={index} 
        ...
        >
            {(provided) => (
                <div
                    ...
                    className="bg-white rounded-md p-3 mt-3 last:mb-0"
                >
                    <label 
                        className={
                            `bg-gradient-to-r px-2 py-1 rounded text-white text-sm
                            ${data.priority === 0 ? 'from-blue-600 to-blue-400' 
                            : data.priority === 1 ? 'from-green-600 to-green-400'
